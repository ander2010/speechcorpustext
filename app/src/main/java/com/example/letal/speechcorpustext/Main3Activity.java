...
public class Main3Activity extends AppCompatActivity  implements View.OnClickListener {
    ...
    /**
     * Método sobreescrito generado a partir de la implementación de  un View.OnClickListener y es para saber a que componente se dió clic
     * Este Método realiza el case para obtener cual es el elemento cliqueado y a que actividad se va a llamar.
     * @param   v Este parámetro te da acceso a la vista y especificamente funciona para saber el id que fue presionado
     *
     *
     */
     ...
     * @param  addresses,subject a este método se le pasan dos parámetros el primero es el arreglo de direcciones y el segundo es el asunto del correo electrónico
     *
     *
     */
